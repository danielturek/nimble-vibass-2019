...
The Github site ([https://github.com/danielturek/nimble-vibass-2019](https://github.com/danielturek/nimble-vibass-2019)) is the master repository for materials for the modules; you can also get the individual files from Github. 

To get the materials look ahead to slide 6 for instructions. Alternatively, simply go to [https://github.com/danielturek/nimble-vibass-2019](https://github.com/danielturek/nimble-vibass-2019) and click on the 'Download ZIP' button in the right side of the window or simply click [here](https://github.com/danielturek/nimble-vibass-2019/archive/master.zip).

## Asking questions and making comments

Please ask questions and make comments as we go through the material. We will also have a shared document (Etherpad) at [https://etherpad.net/p/nimble-vibass-2019](https://etherpad.net/p/nimble-vibass-2019) where you can more easily post longer code snippets or error messages.
...
Simply go to [https://github.com/danielturek/nimble-vibass-2019](https://github.com/danielturek/nimble-vibass-2019) and click on the 'Download ZIP' button in the right side of the window or simply click [here](https://github.com/danielturek/nimble-vibass-2019/archive/master.zip).
