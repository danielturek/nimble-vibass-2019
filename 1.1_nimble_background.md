...
We have an extensive website (<a href="r-nimble.org)" target="_blank" style="color: blue">https://r-nimble.org</a> with fairly comprehensive User Manual, examples, and other information.
...
* various sequential Monte Carlo packages
  ...
  3. <a href="https://alea.bordeaux.inria.fr/biips/doku.php?id=home" target="_blank" style="color: blue">BIIPS</a>
...
* Email <a href="the NIMBLE development team" target="_blank" style="color: blue">nimble.stats@gmail.com</a>
...
* Email <a href="the NIMBLE development team" target="_blank" style="color: blue">nimble.stats@gmail.com</a> if you're interested in participating in the development of NIMBLE. 
